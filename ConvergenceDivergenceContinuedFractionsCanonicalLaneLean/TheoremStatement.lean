import HautevilleHouse.ConvergenceDivergenceContinuedFractionsCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  constrainedStatement := "constrained continued fraction convergence/divergence theorem internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
...
def ConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "theorem_constrained" ∧
